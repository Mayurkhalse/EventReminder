...
<head>
    ...
    <title>Edit Event - Event Reminder</title>
    ...
    <div class="main-content-wrapper">
        ...
        <main class="content">
             <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
                <h1 style="font-size: 1.5rem; font-weight: 700;">Update Event Details</h1>
            ...
            <div class="card">
                <form action="edit_event.php?id=<?php echo $event['id']; ?>" method="POST">
                    ...
                    <div style="margin-top: 2rem; display: flex; justify-content: flex-end; gap: 1rem;">
                        ...
                        <button type="submit" class="btn btn-primary" style="width: auto;">Update Event</button>
                    </div>
                </form>
            </div>
        </main>
